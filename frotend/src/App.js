...
// import RazorPayPayment from './component/Cart/RazorPayPament'
...
import ShippingPolicyPage from "./Terms&Condtions/Shipping";
import CategoryPage from "./component/Category/CategoryPage.jsx"
  ...
  return (
    <>
      <Router>
        ...
        {/* <Route exact path="/process/payment">
          {<Header />}
          <PrivateRoute exact path="/process/payment" component={RazorPayPayment} />
        </Route> */}
      </Router>
    </>
  );

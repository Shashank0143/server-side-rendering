...
const classes = useStyles();
  ...
  const handleClickOpenCustomDialog = () => {
            ...
            <div className={classes.secondBlock_left}>
              <div className={classes.productDetailsContainer}>
                ...
                <div>
                  ...
                  {!product.measurements && (<Typography variant="body2" className={classes.productQty}>
                    <strong>Size:</strong> {product.size}
                  </Typography>)}
                  <div>
                    {!product.size && (<Button variant="outlined" color="primary" onClick={handleClickOpenCustomDialog}>
                      View Custom Details
                    </Button>)}
                  </div>
                  <Typography

          ...
          <form className={classes.form}>
            ...
            >
              <Grid item>
                <FormControlLabel
                  control={<Checkbox />}
                  label="I Accept The Fashion Clothing Terms & Conditions"
              ...
              <Grid item>
                <FormControlLabel
                  control={<Checkbox />}
                  label="I Accept The Fashion Clothing Terms Of Use"
                  className={classes.checkbox}
            ...
            >
              I acknowledge Fashion Clothing will use my information in accordance
              with its

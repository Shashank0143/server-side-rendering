...
const ContactForm = () => {
  ...
  const handleCall = () => {
    window.location.href = "tel:+918929889345";
  };
  ...
  return (
    <Box className={classes.root_contactus}>
      ...
      <div className={classes.contact_Container_contactus}>
        ...
        <Typography variant="body2" className={classes.para_contact}>
          <span className={classes.para2}>09:00-18:00 IST Monday-Friday</span>
          <br />
          <span className={classes.para2}>09:00-14:00 IST Saturday</span>
          <br />

    ...
    <div className="privacy-policy-container">
      ...
      <div className="container___">
        ...
        <p>
          ...
          experience purchasing from our webstore, phbypriyanshu.com.
        </p>
        <p>
        ...
        <p>
          You (“Customer”) may place orders for Products with PH by Priyanshu
          ...
          agreed to or set forth in writing by PH by Priyanshu, any term or
        ...
        <h2>Orders</h2>
        <p>
          All orders are subject to PH by Priyanshu's acceptance. This means
          PH by Priyanshu may, for any reason, refuse to accept or may cancel or
          ...
          cancel an order after you have already been charged, PH by Priyanshu
        ...
        <p>
          ...
          and it is accepted by PH by Priyanshu. Prices for products displayed on
          ...
          website may differ from those in stores that stock PH by Priyanshu
          products, as these stores are independent of PH by Priyanshu.
          PH by Priyanshu reserves the right to amend pricing for any pricing
          ...
          submitted an online order, PH by Priyanshu will notify you of the error
        ...
        <p>
          ...
          PH by Priyanshu reserves the right to change or discontinue such offers
          at any time.
        </p>
        <h2>Taxes</h2>
        <p>
          The prices quoted for the products sold hereunder include applicable
          taxes. Customer shall pay, and reimburse PH by Priyanshu if it pays, any
          taxes, except for those based on PH by Priyanshu's income.
        </p>
        <h2>Payment</h2>
        <p>
        ...
        <p>
          ...
          process. Any timeframe provided by PH by Priyanshu for when the
          ...
          are beyond our control. PH by Priyanshu cannot be held liable for late
        ...
        <h2>Returns</h2>
        <p>
          Once an order has been placed and accepted by PH by Priyanshu, customer
          may not cancel such accepted order without PH by Priyanshu’s prior
          ...
          expenses. The product(s) must be returned to PH by Priyanshu within
        ...
        <p>
          ...
          indemnify and hold PH by Priyanshu harmless from and against any and all
        ...
        <p style={{ fontWeight: "500" }}>PH by Priyanshu</p>
        <p style={{ fontWeight: "500" }}>Sec 126, Radha Ballabh Campus, Noida, Uttar Pradesh</p>
        <p style={{ fontWeight: "500" }}>
          Email:{" "}
          <span style={{ fontWeight: "400" }}>phbypriyanshu886@gmail.com</span>
        </p>
      </div>
    </div>
  );
